          ...
          <div className="mx-auto tm-content-container">
            <main>
              ...
              <div className="row mb-5 pb-5">
                <div className="col-xl-8 col-lg-7">
                  ...
                  <div className="tm-video-description-box">
                    ...
                    <p className="mb-4">
                      ...
                      vestibulum ipsum. Maecenas ultricies ipsum a urna
                      ullamcorper, id interdum est blandit. Vivamus sit amet
                      justo sed erat iaculis consequat. Nulla suscipit posuere
                      lectus ut venenatis. Proin sed orci eget tellus euismod
                      vulputate eu eu arcu.
                    </p>
                    <p className="mb-4">
                      Etiam a bibendum lorem. Curabitur ac bibendum odio.
                      Vivamus euismod dui mauris, ut tincidunt mi congue quis.
                      Phasellus luctus orci dolor, a luctus massa tincidunt
                      vitae. Integer sit amet odio id libero tincidunt dignissim
                      in eget arcu.
                    </p>
                    <p className="mb-4">
                ...
                <div className="col-xl-4 col-lg-5">
                  ...
                  <div className="tm-bg-gray tm-share-box">
                    <h6 className="tm-share-box-title mb-4">
                      Share this video
                    </h6>
              ...
              <div className="row pt-4 pb-5">
                <div className="col-12">
                  <h2 className="mb-5 tm-text-primary">
